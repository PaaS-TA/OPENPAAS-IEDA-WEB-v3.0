...
public interface HbIaasConfigMgntDAO {
    ...
    ***************************************************/
    List<HbIaasConfigMgntVO> selectAllIaasConfigInfoList(@Param("userId") String userId);
    ...
    ***************************************************/
     ...
     * @return : List<IaasConfigMgntVO>
    ***************************************************/
    List<HbIaasConfigMgntVO> selectIaasConfigInfoList(@Param("userId") String userId, @Param("iaasType") String iaasType);
     ...
     * @return : int
    ***************************************************/
    int selectIaasConfigDuplicationByConfigInfo(@Param("config") HbIaasConfigMgntVO vo);
    ...
    ***************************************************/
     ...
     * @return : int
    ***************************************************/
    int insertIaasConfigInfo(@Param("config") HbIaasConfigMgntVO vo);
    ...
    ***************************************************/
    HbIaasConfigMgntVO selectIaasConfigInfo(@Param("userId") String userId, @Param("iaasType") String iaasType, @Param("id") int id);
     ...
     * @return : void
    ***************************************************/
    int updateIaasConfigInfo(@Param("config") HbIaasConfigMgntVO vo);
