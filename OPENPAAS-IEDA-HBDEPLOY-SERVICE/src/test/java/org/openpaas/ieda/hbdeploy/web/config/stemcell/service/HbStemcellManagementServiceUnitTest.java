...
@WebAppConfiguration
public class HbStemcellManagementServiceUnitTest extends BaseHbDeployControllerUnitTest{
    
    @InjectMocks 
    HbStemcellManagementService mockHbStemcellService;
    @Mock
    ...
    ***************************************************/
    ...
    public void testGetStemcellListFromValueNullCase(){
        when(mockHbStemcelldao.selectHybridStemcellList("aws")).thenReturn(null);
    ...
    * @title : testGetHybridStemcellListFromNullStatusCase
    * @return : void
    ***************************************************/
    @Test
    ...
    * @title : testGetHybridStemcellListFromDonwloadedStatusCase
    * @return : void
    ***************************************************/
    @Test
    public void testGetHybridStemcellListFromDonwloadedStatusCase(){
        List<HbStemcellManagementVO> stemcellList = getStemcellReturnListInfo("downloaded");
        when(mockHbStemcelldao.selectHybridStemcellList("aws")).thenReturn(stemcellList);
        List<HbStemcellManagementVO> result = mockHbStemcellService.getHybridStemcellList("aws");
        assertEquals(result.size(), 1);
        assertEquals(result.get(0).getStemcellUrl(), stemcellList.get(0).getStemcellUrl());
    ...
    ***************************************************/
    ...
    public void testSaveStemcellInfoByFilePathFromLockFileConflictCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("nomal");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(false);
        mockHbStemcellService.saveStemcellInfoByFilePath(dto, "Y", principal);
    }
    ...
    ***************************************************/
    ...
    public void testSaveStemcellInfoByFilePathFromExtensionErrorCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("extension");
    ...
    ***************************************************/
    ...
    public void testSaveStemcellInfoByFilePathFromSizeZeroCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("zero");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        mockHbStemcellService.saveStemcellInfoByFilePath(dto, "Y", principal);
    }
    ...
    ***************************************************/
    ...
    public void testSaveStemcellInfoByFilePathFromOverlayFalseException() throws IOException{
        ...
        writer.flush();
        writer.close();
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("overlay");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        mockHbStemcellService.saveStemcellInfoByFilePath(dto, "Y", principal);
    }
    ...
    ***************************************************/
    ...
    public void testSaveStemcellInfoByFilePath(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("nomal");
        HbStemcellManagementVO vo = getStemcellRegistInfo("nomal");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        when(mockHbStemcelldao.selectHybridStemcellById(anyInt())).thenReturn(vo);
        HbStemcellManagementVO result = mockHbStemcellService.saveStemcellInfoByFilePath(dto, "Y", principal);
    ...
    ***************************************************/
    ...
    public void testCheckDownloadInfoOfStemcellByURL(){
        ...
        HbStemcellManagementVO vo = getStemcellRegistInfo("nomal");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        when(mockHbStemcelldao.selectHybridStemcellInfoByFileName(anyString())).thenReturn(null);
        when(mockHbStemcelldao.selectHybridStemcellById(anyInt())).thenReturn(vo);
        HbStemcellManagementVO result =  mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
        assertEquals(result.getStemcellName(), vo.getStemcellName());
        assertEquals(result.getStemcellFileName(), vo.getStemcellFileName());
        assertEquals(result.getStemcellVersion(), vo.getStemcellVersion());
        assertEquals(result.getId(), vo.getId());
    ...
    ***************************************************/
    ...
    public void testCheckDownloadInfoOfStemcellByURLFromStemcellInfoUpdateCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("update");
        HbStemcellManagementVO vo = getStemcellRegistInfo("nomal");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        when(mockHbStemcelldao.selectHybridStemcellInfoByFileName(anyString())).thenReturn(vo);
        when(mockHbStemcelldao.selectHybridStemcellById(anyInt())).thenReturn(vo);
        HbStemcellManagementVO result =  mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "N", principal);
        assertEquals(result.getStemcellName(), vo.getStemcellName());
        assertEquals(result.getStemcellFileName(), vo.getStemcellFileName());
        assertEquals(result.getStemcellVersion(), vo.getStemcellVersion());
        assertEquals(result.getId(), vo.getId());
    ...
    ***************************************************/
    ...
    public void testCheckDownloadInfoOfStemcellByURLFromExceptionCase(){
        HbStemcellManagementDTO.Regist dto = null;
        HbStemcellManagementVO vo = getStemcellRegistInfo("error");
        when(mockMessageSource.getMessage(anyString(), anyObject(), anyObject())).thenReturn("conflic_exception");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        when(mockHbStemcelldao.selectHybridStemcellInfoByFileName(anyString())).thenReturn(vo);
        doNothing().when(mockHbStemcelldao).insertHybridStemcell(null);
        mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
    }
    ...
    *****************************************************************/
    @Test
    public void doWgetToGetHybridStemcellInfo(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("nomal");
        dto.setFileType("URL");
        dto.setStemcellUrl("bosh.io");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        mockHbStemcellService.doWgetToGetHybridStemcellInfo(dto, "Y", principal);
    }
     ...
     * @title : testDoWgetToGetHybridStemcellInfoFromBadRequestCase
     * @return : void
    *****************************************************************/
    @Test(expected=CommonException.class)
    public void testDoWgetToGetHybridStemcellInfoFromBadRequestCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("nomal");
    ...
    *****************************************************************/
    ...
    public void testSetStemcellUrlForWgetByWindowsType(){
        HbStemcellManagementDTO.Regist dto = setStemcellVersionDownloadInfo("windows");
        String result = mockHbStemcellService.setStemcellUrlForWget(dto);
    ...
    ***************************************************/
    ...
    public void testSetStemcellUrlForWget(){
        HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("nomal");
        String result = mockHbStemcellService.setStemcellUrlForWget(dto);
    ...
    ***************************************************/
    ...
    public void testCheckDownloadInfoOfStemcellByURLFromFileSizeZeroCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUploadInfo("empty");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
    }
    ...
    ***************************************************/
    ...
    public void testSaveStemcellInfoByURLFromCentosVersionTypeCase(){
        ...
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        when(mockHbStemcelldao.selectHybridStemcellById(anyInt())).thenReturn(vo);
        HbStemcellManagementVO result =  mockHbStemcellService.saveStemcellInfoByURL(dto, "Y", principal);
        assertEquals(result.getStemcellName(), vo.getStemcellName());
        assertEquals(result.getStemcellFileName(), vo.getStemcellFileName());
        assertEquals(result.getStemcellVersion(), vo.getStemcellVersion());
        assertEquals(result.getId(), vo.getId());
    ...
    *****************************************************************/
    ...
    public void testSaveStemcellInfoByURLFromBadRequestCase(){
        ...
        mockHbStemcellService.saveStemcellInfoByURL(dto, "Y", principal);
    }
    ...
    ***************************************************/
    ...
    public void testSetStemcellDownLoadSubUrlByVersionTypeFromAWSLightCase(){
        HbStemcellManagementDTO.Regist dto = new HbStemcellManagementDTO.Regist();
        dto.setLight("true");
        String resultSubUrl = mockHbStemcellService.setStemcellDownLoadSubUrlByVersionType(dto);
    ...
    ***************************************************/
    ...
    public void testSetIaasHypervisorFromOpenstack(){
        ...
        String resultHypervisor = mockHbStemcellService.setIaasHypervisor(dto);
    ...
    ***************************************************/
    public void testSetStemcellDownLoadBaseUrlByVersionTypeFromLight3264MoreCase(){
        ...
        dto.setLight("true");
        dto.setIaasType("AWS");
        String resulBaseUrl = mockHbStemcellService.setStemcellDownLoadBaseUrlByVersionType(dto);
    ...
    ***************************************************/
    ...
    public void testSetStemcellVersionWithWgetFrom2820LightCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("nomal");
        String resultVersion = mockHbStemcellService.setStemcellVersionWithWget(dto);
    ...
    ***************************************************/
    ...
    public void testSetStemcellVersionWithWgetFromWithoutBoshIo2820Case(){
        HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("notBoshIo");
    ...
    ***************************************************/
    ...
    public void testSetStemcellVersionWithWgetFromBoshIo2820Case(){
        HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("boshio");
        dto.setStemcellFileName("bosh-stemcell-2820-aws-xen-hvm-ubuntu-trusty-go_agent.tgz");
        String resultVersion = mockHbStemcellService.setStemcellVersionWithWget(dto);
        assertEquals(resultVersion, "2820");
    }
    ...
    ***************************************************/
    ...
    public void testSetStemcellVersionWithWgetFromBoshIo2820LightCase(){
        HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("boshiolite");
        String resultVersion = mockHbStemcellService.setStemcellVersionWithWget(dto);
        assertEquals(resultVersion, "2820");
    }
    ...
    ***************************************************/
    public void testSetStemcellDownLoadBaseUrlByVersionTypeFromNumberFormatException(){
        ...
        mockHbStemcellService.setStemcellDownLoadBaseUrlByVersionType(dto);
    }
    ...
    ***************************************************/
    @Test
    public void testDeleteHybridStemcell() throws IOException{
        HbStemcellManagementDTO.Delete  dto = setStemcellDeleteData();
        File file = new File(STEMCELL_PATH + SEPARATOR + "light-bosh-stemcell-2820-aws-xen-hvm-ubuntu-trusty-go_agent.tgz");
        FileWriter writer = null;
        writer = new FileWriter(file);
        writer.write("test"); 
        writer.flush();
        writer.close();
        mockHbStemcellService.deleteHybridStemcell(dto);
    }
    ...
    * @return : HbStemcellManagementDTO.Delete
    ***************************************************/
    private HbStemcellManagementDTO.Delete setStemcellDeleteData(){
     ...
     ***************************************************/
     ...
     public void testGetListLocalStemcellsValueNull(){
         when(mockHbStemcelldao.selectLocalStemcellListByIaas("openstack")).thenReturn(null);
         List<HbStemcellManagementVO> result = mockHbStemcellService.getLocalStemcellList("openstack");
         assertEquals(result, null);
     }
     ...
     ***************************************************/
     ...
     public void testGetListLocalStemcellsDownLoadStatusValueNull(){
         List<HbStemcellManagementVO> stemcellList = getStemcellReturnListInfo("null");
         when(mockHbStemcelldao.selectLocalStemcellListByIaas(anyString())).thenReturn(stemcellList);
         List<HbStemcellManagementVO> result = mockHbStemcellService.getLocalStemcellList("openstack");
         assertEquals(result.size(), 1);
         assertEquals(result.get(0).getStemcellUrl(), stemcellList.get(0).getStemcellUrl());
         assertEquals(result.get(0).getStemcellFileName(), stemcellList.get(0).getStemcellFileName());
    ...
    * @title : testRegistHybridStemcellDownLoadBoshIoUrl
    * @return : void
    ***************************************************/
    @Test
     public void testRegistHybridStemcellDownLoadBoshIoUrl(){
        HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("boshio");
        when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
        mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
     }
   ...
   * @title : testRegistHybridStemcellDownLoadBoshIoLiteUrl
   * @return : void
   ***************************************************/
   @Test
    public void testRegistHybridStemcellDownLoadBoshIoLiteUrl(){
       HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("boshiolite");
       when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
       mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
    }
  ...
  * @title : testRegistHybridStemcellDownLoadIfNotLite
  * @return : void
  ***************************************************/
   @Test 
   public void testRegistHybridStemcellDownLoadIfNotLite(){
       HbStemcellManagementDTO.Regist dto = setStemcellVersionDownloadInfo("ifNotLite");
       when(mockCommonService.lockFileSet(anyString())).thenReturn(true);
       mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
   }
  ...
  * @title : testRegistHybridStemcellDownladFileExistAndOverlayCheckFlase
  * @return : void
  ***************************************************/
   @Test(expected=CommonException.class)
   public void testRegistHybridStemcellDownladFileExistAndOverlayCheckFlase() throws IOException{
       HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("overlay");
       File file = new File(STEMCELL_PATH + SEPARATOR + "light-bosh-stemcell-2820-aws-xen-hvm-ubuntu-trusty-go_agent.tgz");
       FileWriter writer = null;
       writer = new FileWriter(file);
       writer.write("test"); 
  ...
  * @title : testRegistHybridStemcellDownladUrlBadRequest
  * @return : void
  ***************************************************/
   @Test(expected=CommonException.class)
   public void testRegistHybridStemcellDownladUrlBadRequest() throws IOException{
       HbStemcellManagementDTO.Regist dto = setStemcellUrlDownloadInfo("badrequest");
       mockHbStemcellService.checkDownloadInfoOfStemcellByURL(dto, "Y", principal);
   }
  ...
  ***************************************************/
    ...
    * @return : HbStemcellManagementDTO.Regist
    ***************************************************/
    private HbStemcellManagementDTO.Regist setStemcellVersionDownloadInfo(String type) {
        HbStemcellManagementDTO.Regist dto = new HbStemcellManagementDTO.Regist();
        dto.setId(1);
    ...
    * @return : HbStemcellManagementDTO.Regist
    ***************************************************/
    public HbStemcellManagementDTO.Regist setStemcellUrlDownloadInfo(String type) {
        HbStemcellManagementDTO.Regist dto = new HbStemcellManagementDTO.Regist();
        dto.setRecid(1);
        dto.setId(1);
    ...
    ***************************************************/
    private List<HbStemcellManagementVO> getStemcellReturnListInfo(String type) {
    ...
    * @return : HbStemcellManagementVO
    ***************************************************/
    private HbStemcellManagementVO getStemcellRegistInfo(String type){
        HbStemcellManagementVO vo = new HbStemcellManagementVO();
    ...
    * @return : HbStemcellManagementDTO.Regist
    ***************************************************/
    private HbStemcellManagementDTO.Regist setStemcellUploadInfo(String type) {
        HbStemcellManagementDTO.Regist dto = new HbStemcellManagementDTO.Regist();
        dto.setId(1);
        dto.setStemcellName("testStemcellFile");
