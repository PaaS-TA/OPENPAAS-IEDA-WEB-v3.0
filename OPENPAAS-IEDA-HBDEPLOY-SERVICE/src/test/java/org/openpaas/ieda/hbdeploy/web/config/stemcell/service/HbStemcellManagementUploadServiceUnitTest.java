...
@WebAppConfiguration
public class HbStemcellManagementUploadServiceUnitTest extends BaseHbDeployControllerUnitTest{

    @InjectMocks
    HbStemcellManagementUploadService mockHbStemcellManagementUploadService;
    
    @Mock
    HbStemcellManagementDAO mockHbStemcellManagementDAO;
    ...
    ***************************************************/
    ...
    public void testSavePublicStemcell(){
        HbStemcellManagementDTO.Regist dto = setReleaseDownloadInfo();
        mockHbStemcellManagementUploadService.saveStemcellInfo(dto, principal);
    }
    ...
    ***************************************************/
    private HbStemcellManagementDTO.Regist setReleaseDownloadInfo() {
