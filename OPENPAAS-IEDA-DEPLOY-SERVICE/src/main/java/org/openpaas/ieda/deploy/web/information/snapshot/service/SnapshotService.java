package org.openpaas.ieda.deploy.web.information.snapshot.service;
...
public class SnapshotService {
    ...
    ***************************************************/
    public String deleteSnapshots(String type, SnapshotListDTO dto){
        ...
        if ( defaultDirector == null ) {
            throw new CommonException("notfound.director.exception", "설치 관리자 정보가 존재하지 않습니다.", HttpStatus.NOT_FOUND);
        }
