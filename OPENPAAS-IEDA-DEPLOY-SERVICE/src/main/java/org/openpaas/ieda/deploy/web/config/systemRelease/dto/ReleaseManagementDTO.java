package org.openpaas.ieda.deploy.web.config.systemRelease.dto;
...
public class ReleaseManagementDTO {
    ...
    public static class Regist{
        ...
        private String releasePathUrl;
        private String iaasType;
        private String releasePathVersion;
        ...
        public String getReleasePathUrl() {
            return releasePathUrl;
        }
        public void setReleasePathUrl(String releasePathUrl) {
            this.releasePathUrl = releasePathUrl;
        }
        public String getReleasePathVersion() {
            return releasePathVersion;
        }
        public void setReleasePathVersion(String releasePathVersion) {
            this.releasePathVersion = releasePathVersion;
        }
