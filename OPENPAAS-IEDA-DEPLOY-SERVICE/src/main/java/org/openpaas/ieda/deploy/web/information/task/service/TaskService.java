...
public class TaskService {
    ...
    ***************************************************/
    ...
    public List<TaskListDTO> listTask() {
        ...
        List<TaskListDTO> contents = new ArrayList<TaskListDTO>();
        try {
     ...
     * @return : void
    ***************************************************/
    public void getDownloadDebugLogFile(String taskId, HttpServletResponse response) {
        String content = "";
        String fileName = "";
        int statusCode = 0;
        try {
