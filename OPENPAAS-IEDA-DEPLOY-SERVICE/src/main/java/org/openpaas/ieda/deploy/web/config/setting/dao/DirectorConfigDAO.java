...
public interface DirectorConfigDAO {
    ...
    ***************************************************/
    ...
    /***************************************************
     * @project : Paas 플랫폼 설치 자동화
     * @description : 설치관리자 정보 조회
     * @title : selectDirectorConfigInfoByDirectorNameAndCPI
     * @return : DirectorConfigVO
    ***************************************************/
    DirectorConfigVO selectDirectorConfigInfoByDirectorNameAndCPI(@Param("director_cpi") String cpi
                                                                , @Param("director_name") String name);
}
