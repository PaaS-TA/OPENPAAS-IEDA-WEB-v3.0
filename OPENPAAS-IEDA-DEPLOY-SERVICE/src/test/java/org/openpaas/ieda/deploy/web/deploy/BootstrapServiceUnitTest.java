...
public class BootstrapServiceUnitTest extends BaseDeployControllerUnitTest{
    ...
    @Mock
    private CommonDeployService mockCommonDeployService;
    @Mock
    private DirectorConfigDAO mockDirectorConfigDAO;
    @Mock
    private MessageSource mockMessageSource;
    
    final static Logger LOGGER = LoggerFactory.getLogger(BootstrapServiceUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGetBootstrapList(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testGetBootstrapList"); }
    ...
    *****************************************************************/
    ...
    public void testGetBootstrapInfo(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testGetBootstrapInfo"); }
    ...
    *****************************************************************/
    ...
    public void testGetBootstrapInfoBadRequestCase(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testGetBootstrapInfoBadRequestCase"); }
    ...
    *****************************************************************/
    ...
    public void testGetSnapshotInfo(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testGetSnapshotInfo"); }
    ...
    *****************************************************************/
    ...
    public void testGetSnapshotInfoBadRequestCase(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testGetSnapshotInfoBadRequestCase"); }
        DirectorConfigVO director = setDirectorConfigInfo();
    ...
    *****************************************************************/
    ...
    public void testMakeReplaceItemsFromGoogle(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testMakeReplaceItemsFromGoogle"); }
    ...
    *****************************************************************/
    ...
    public void testCreateSettingFileBootstrapNullCase(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testCreateSettingFileBootstrapNullCase"); }
        when(mockBootstrapDAO.selectBootstrapInfo(anyInt())).thenReturn(null);
    ...
    *****************************************************************/
    ...
    public void testCreateSettingFileManifestTemplateNullCase(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testCreateSettingFileManifestTemplateNullCase"); }
        BootstrapVO vo = setBootstrapInfo("Openstack");//data 상세 조회
        when(mockBootstrapDAO.selectBootstrapInfo(anyInt())).thenReturn(vo);
    ...
    *****************************************************************/
    ...
    public void testSetOptionManifestTemplateInfoFrom256Release(){
        ...
        mockBootstrapService.setOptionManifestTemplateInfo(manifestTemplate, "openstack");
    }
   ...
   @Test
    public void testSetOptionManifestTemplateInfoFromEmptyValue(){
        ...
        ManifestTemplateVO result = mockBootstrapService.setOptionManifestTemplateInfo(manifestTemplate, "openstack");
   ...
   public void testDeleteBootstrapInfo(){
       if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testDeleteBootstrapInfo"); }
   ...
   public void testDeleteBootstrapInfoBadRequestCase(){
       if(LOGGER.isInfoEnabled()){  LOGGER.info("=================> testDeleteBootstrapInfoBadRequestCase"); }
    ...
    *****************************************************************/
    public BootstrapVO setBootstrapInfo(String iaasType){
        ...
        if( iaasType.equals("Openstack") ){
            ...
            vo.setOsConfRelease("os-conf-release");
            vo.getIaasAccount().put("googleJsonKey", "googleJsonKey");
            vo.getIaasConfig().setGooglePublicKey("googlePublicKey");
        }
