package org.openpaas.ieda.common.socket;
...
public class WebSocketConfig extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry config) {
        config.enableSimpleBroker( "/socket"
                                ...
                                , "/config/hbRelease/regist/socket/logs"
                                , "/config/hbRelease/regist/download/logs"
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint( "/config/stemcell/regist/stemcellDownloading"
                            ...
                            , "/config/hbRelease/regist/download/hbReleaseDownloading"
