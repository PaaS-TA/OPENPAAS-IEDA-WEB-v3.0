	...
	$("#googleNetworkInfoForm").validate({
        ...
        rules:{
        	publicStaticIp_1 : {
	            ...
	            required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='availabilityZone_1']").val() ); }
	        }, subnetRange_1: { 
	         ...
	         ,cloudSecurityGroups_1: { required: "방화벽 규칙"+text_required_msg }
	         ,availabilityZone_1   : { required: "영역"+text_required_msg }
