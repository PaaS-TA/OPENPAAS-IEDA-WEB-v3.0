...
$("#vSphereNetworkInfoForm").validate({
        ...
        rules:{
        	publicSubnetId : {
                required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='publicSubnetId']").val() ); } 
            },publicSubnetRange : {
                required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='publicSubnetRange']").val() ); }
               ,ipv4Range: function(){ return $(".w2ui-msg-body input[name='publicSubnetRange']").val(); }
            },publicSubnetGateway : {
                required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='publicSubnetGateway']").val() ); }
               ,ipv4: function(){ return $(".w2ui-msg-body input[name='publicSubnetGateway']").val(); }
            },publicSubnetDns : {
                required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='publicSubnetDns']").val() ); }
                ,ipv4: function(){ return $(".w2ui-msg-body input[name='publicSubnetDns']").val(); }
            },publicStaticFrom : {
                required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='publicStaticFrom']").val() ); }
               ,ipv4: function(){ return $(".w2ui-msg-body input[name='publicStaticFrom']").val(); }
            }, publicStaticTo: { 
                required : function(){ return checkEmpty( $(".w2ui-msg-body input[name='publicStaticTo']").val() ); }
               ,ipv4: function(){ return $(".w2ui-msg-body input[name='publicStaticTo']").val(); }
            }, subnetId_1: { 
