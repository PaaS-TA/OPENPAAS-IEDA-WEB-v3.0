...
var config = {
    ...
    /********************************************************
     * 설명 : Openstack 서브넷 추가 팝업 화면 Function 
     * Function : subnetAdd
     *********************************************************/
    ...
    /********************************************************
     * 설명 : Openstack 네트워크 상세 조회 Function 
     * Function : doSearchNetworkDetailInfo
     *********************************************************/
    ...
    function saveOpenstackNetworkInfo(){
        ...
        var networkInfo = {
            ...
            dnsNameServers : $(".w2ui-msg-body input[name='dnsNameServers']").val(),
    ...
    /********************************************************
     * 설명 : Openstack 네트워크 정보 삭제 function
     * Function : deleteOpenstackNetworkInfo
     *********************************************************/
    ...
    /********************************************************
     * 설명 : Openstack 서브넷 정보 저장 function
    ...
    /********************************************************
     * 설명 : Openstack 서브넷 정보 삭제 function
    ...
    function subNetInitSetting(record){
        ...
        $(".w2ui-msg-body input[name='dnsNameServers']").val("");
    }
        ...
        <div class="panel panel-info"> 
            ...
            <div class="panel-body" style="padding:20px 10px; height:340px; overflow-y:auto;">
                ...
                <div class="w2ui-field">
                    ...
                    <div style="width: 50%">
                        <input  name="adminState" type="checkbox"  checked/>&nbsp;
                    </div>
                </div>
                <div class="w2ui-field">
                ...
                <div class="w2ui-field">
                    ...
                    <div style="width: 50%">
                        <input  name="enableDHCP" type="checkbox"  checked/>&nbsp;
                    </div>
                </div>
                <div class="w2ui-field">
                    <label style="width:36%;text-align: left; padding-left: 20px;">DNS Name Servers</label>
                    <div>
                        <input name="dnsNameServers" type="text"   maxlength="100" style="width: 320px; margin-top: 1px;" placeholder="DNS 주소를 입력하세요."/>
                    </div>
                </div>
            </div>
        </div>
...
<div id="registPopupBtnDiv" hidden="true">
     ...
     <div class="pdt20" >
        <div class="title fl">OPENSTACK Network 상세 목록</div>
    </div>
    ...
    <div id="regSubPopupDiv" hidden="true">
        <form id="settingForm" action="POST" >
            <div class="panel panel-info" style="margin-top:5px;" >
                ...
                <input type="hidden" name="accountId"/>
                    <div class="w2ui-field">
                        <label style="width:100%;text-align: left;padding-left: 20px;">Subnet Name</label>
                        <div >
                            <input name="subnetName" type="text" maxlength="100" style="width: 365px" required="required" placeholder="서브넷 명을 입력하세요." />
                        </div>
                    </div>
                    <div class="w2ui-field">
                        <label style="width:100%;text-align: left;padding-left: 20px;">Network Address</label>
                        <div >
                            <input name="networkAddress" type="text" maxlength="100" style="width: 365px" required="required" placeholder="네트워크 주소를 입력하세요."  />
                        </div>
                    </div>
                    <div class="w2ui-field">
                        <label style="width:100%;text-align: left;padding-left: 20px;">Gateway IP</label>
                        <div >
                    ...
                    <div class="w2ui-field">
                        <label style="width:55%;text-align: left; padding-left: 20px;">DNS Name Servers</label>
                        <div>
                            <input name="dnsNameServers" type="text" maxlength="100" style="width: 365px; margin-top: 1px;" placeholder="DNS 주소를 입력하세요."/>
                        </div>
                    </div>
                </div>
            </div>
...
$(function() {
    ...
    $.validator.addMethod( "ipv6", function( value, element, params ) {
        if( params ){
            return /^((([0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}:[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){5}:([0-9A-Fa-f]{1,4}:)?[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){4}:([0-9A-Fa-f]{1,4}:){0,2}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){3}:([0-9A-Fa-f]{1,4}:){0,3}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){2}:([0-9A-Fa-f]{1,4}:){0,4}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(([0-9A-Fa-f]{1,4}:){0,5}:((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(::([0-9A-Fa-f]{1,4}:){0,5}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|([0-9A-Fa-f]{1,4}::([0-9A-Fa-f]{1,4}:){0,5}[0-9A-Fa-f]{1,4})|(::([0-9A-Fa-f]{1,4}:){0,6}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){1,7}:))$/i.test( params );     
       }else{
            return true;
       }
    }, text_ip_msg );
    ...
    $("#openstackNetworkForm").validate({
        ...
        rules: {
            ...
            networkAddress : {
                required : function(){
                    return checkEmpty( $(".w2ui-msg-body input[name='networkAddress']").val() );
                }, ipv4Range : function(){
                    if( $(".w2ui-msg-body select[name='ipVersion']").val() == "IPv4" ){
                        return $(".w2ui-msg-body input[name='networkAddress']").val();
                    }else { 
                        return false; 
                    }
                }
            ...
            gatewayIp : {
                required : function(){
                    return checkEmpty( $(".w2ui-msg-body input[name='gatewayIp']").val() );
                }, ipv4 : function(){
                    if( $(".w2ui-msg-body select[name='ipVersion']").val() == "IPv4" ){
                        return $(".w2ui-msg-body input[name='gatewayIp']").val();    
                    }else { 
                        return false; 
                    }
                }, ipv6: function(){
                    if( $(".w2ui-msg-body select[name='ipVersion']").val() == "IPv6" ){
                        return $(".w2ui-msg-body input[name='gatewayIp']").val();
                    }else { 
                        return false; 
                    }
            ...
            dnsNameServers : {
                required : function(){
                    return checkEmpty( $(".w2ui-msg-body input[name='dnsNameServers']").val() );
                }, ipv4 : function(){
                    return $(".w2ui-msg-body input[name='dnsNameServers']").val();
                }
            },
        }, messages: {
            networkName: { 
