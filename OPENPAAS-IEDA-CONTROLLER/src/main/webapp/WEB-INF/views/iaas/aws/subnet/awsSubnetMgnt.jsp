...
var region = "";
    ...
    *********************************************************/
    function checkCheckbox(record){	
    	var result = "";
        result = "</br><div style='color:red'>경고: 만약 이 Default 서브넷을 삭제 하시면, 연관된 가용 지역에 서브넷을 생성하시고 인스턴스 런치할 때 서브넷을 지정하지 않는이상, 가용지역 ( "
   ...
   $("#deleteBtn").click(function(){
       ...
       if( selected.length == 0 ){
           ...
           w2confirm({
               title : "Subnet 삭제",
               msg : "Subnet (" + record.subnetId + ")을 삭제하시겠습니까?<br/>"
                      + result+"</br>",
               yes_text : "삭제하겠습니다",
               no_text : "취소",
               height : 350,
...
<div id="main">
    ...
    <div id="aws_subnetGrid" style="width: 100%; height: 475px;"></div>
