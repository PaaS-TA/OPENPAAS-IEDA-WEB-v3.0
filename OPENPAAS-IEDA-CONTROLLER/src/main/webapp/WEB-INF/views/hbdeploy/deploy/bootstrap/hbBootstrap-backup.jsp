...
function iaasSelectPopup() {
     w2popup.open({
        ...
        body : $("#bootSelectBody").html(),
        buttons: $("#regPopupBtnDiv").html(),
        modal : true,
        onOpen:function(event){
            selectHbDirectorInfo();
...
function selectHbDirectorInfo(){
    $.ajax({
        ...
        success : function(data, status) {
            if(data != null){
                var privateDirectorInfo = "";
                var publicDirectorInfo = "";
                
                for(var i = 0; i < data.length; i ++){
                    if(data[i].directorType == "public"){
                        
                    }else {
                        
                    }
                }
                $(".w2ui-msg-body select[name=publicDirectorName]").append(options);
                $(".w2ui-msg-body select[name=privateDirectorName]").append(options);
            }
        },
...
<div id="bootSelectBody" style="width:100%; height: 80px;" hidden="true">
    <form id="settingForm" action="POST">
        <div class="w2ui-page page-0" style="margin-bottom:30px;">
           <div class="panel panel-info" style="margin-top:30px;" >
               <div class="panel-heading" style="text-align: left;"><b>Public Cloud 환경 디렉터 정보</b></div>
               <div class="panel-body" >
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">디렉터 명</label>
                       <div>
                           <select name="publicDirectorName" onchange="settingDirectorInfo(this.value);" style="width: 320px" >
                               <option value="">디렉터 명을 선택 하세요.</option>
                           </select>
                       </div>
                   </div>
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">인프라 환경</label>
                       <div>
                           <input readonly name="publicIaasType" type="text" maxlength="100" style="width: 320px" placeholder="인프라 환경을 입력 하세요."/>
                       </div>
                   </div>
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">디렉터 URL</label>
                       <div>
                           <input readonly name="publicDriectorUrl" type="text" maxlength="100" style="width: 320px" placeholder="디렉터 URL를 입력 하세요."/>
                       </div>
                   </div>
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">디렉터 UUID</label>
                       <div>
                           <input readonly name="publicDirectorUuid" type="text" maxlength="100" style="width: 320px" placeholder="디렉터 UUID를 입력 하세요."/>
                       </div>
                   </div>
               </div>
           </div>
            <div class="panel panel-info"  style="margin-top:7px;">
               <div class="panel-heading" style="text-align: left;"><b>Private 환경 Cloud 디렉터 정보</b></div>
               <div class="panel-body">
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">디렉터 명</label>
                       <div>
                           <select name="privateDirectorName" onchange="settingDirectorInfo(this.value);" style="width: 320px">
                               <option value="">디렉터 명을 선택 하세요.</option>
                           </select>
                       </div>
                   </div>
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">인프라 환경</label>
                       <div>
                           <input readonly name="privateIaasType" type="text" maxlength="100" style="width: 320px" placeholder="인프라 환경을 입력 하세요."/>
                       </div>
                   </div>
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">디렉터 URL</label>
                       <div>
                           <input readonly name="privateDirectorUrl" type="text" maxlength="100" style="width: 320px" placeholder="디렉터 URL를 입력 하세요."/>
                       </div>
                   </div>
                   <div class="w2ui-field">
                       <label style="width:33%;text-align: left;padding-left: 20px;">디렉터 UUID</label>
                       <div>
                           <input readonly name="privateDirectorUuid" type="text" maxlength="100" style="width: 320px" placeholder="디렉터 UUID를 입력 하세요."/>
                       </div>
                   </div>
               </div>
           </div>
