...
$(function() {
    ...
    $('#config_openstackStemcellsGrid').w2grid({
        name: 'config_openstackStemcellsGrid',
        show: {
            selectColumn: true,
            footer: true
        },
...
<div id="main">
    ...
    <!-- 그리드 영역 -->
    <div id="config_awsStemcellsGrid" style="width:100%; height:309px"></div>

    <!-- OpenPaaS OPENSTACK 스템셀 목록-->
    <div class="pdt20">
        <div class="title fl">OPENSTACK 스템셀 목록</div>
    </div>
    <!-- 그리드 영역 -->
