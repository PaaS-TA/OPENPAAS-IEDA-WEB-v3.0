...
<div id="top">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/platform"> 이종 PaaS-TA <span style="color: #ffffff;">설치 자동화</span></a>
        </div>
 
 <!-- Top Menu Items -->
 <ul class="nav navbar-right top-nav">
 	<li style="padding-top:17px; font-size:14px; color:#ffffff">Welcome to Hybrid Platform Management Dashboard.</li>
