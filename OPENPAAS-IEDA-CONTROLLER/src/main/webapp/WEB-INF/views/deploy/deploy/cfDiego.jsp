...
function cfInstallPopup( cfDeploymentName, diegoDeployment ){
    ...
    w2popup.open({
        ...
        width   : 850,
        height  : 600,
        body    : $("#cfInstallDiv").html(),
        buttons : $("#cfInstallButtons").html(),
        modal   : true,
        showMax : true,
...
function diegoInstallPopup( diegoDeploymentName ){
    ...
    w2popup.open({
        ...
        width   : 850,
        height  : 600,
        body    : $("#diegoInstallDiv").html(),
        buttons : $("#diegoInstallButtons").html(),
        modal   :true,
        showMax :true,
        onOpen :function(event){
            event.onComplete = function(){
...
<div id="main">
    ...
    <!-- CF & Diego 통합 설치 목록 -->
    <div class="pdt20">
        <div class="title fl">CF 및 Diego 통합 설치 목록</div>
        <div class="fr">
            <!-- Btn -->
...
<div id="cfInstallDiv" style="width:100%; height:100%;" hidden="true">
    ...
    <div class="w2ui-buttons" id="cfInstallButtons" hidden="true">
...
<div id="diegoInstallDiv" style="width:100%; height:100%;" hidden="true">
    ...
    <div class="w2ui-buttons" id="diegoInstallButtons" hidden="true">
