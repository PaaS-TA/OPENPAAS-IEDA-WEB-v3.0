...
var deleteClient = "";
    ...
    function saveServicePackInfo(record){
        ...
        $.ajax({
            type : "POST",
            url : "/deploy/servicePack/install/saveServicePackinfo",
            contentType : "application/json",
    ...
    function createSettingFile(id, deploymentFile){
        $.ajax({
            type : "POST",
            url : "/deploy/servicePack/install/createSettingFile/"+id,
            contentType : "application/json",
            async : true,
 ...
 <style>
    input[type="radio"] {
        width:23px;height:16px;vertical-align:text-top
    }
