                ...
                <form id="loginForm" method="post">
                    <fieldset>
                        ...
                        <div class="form-group custom-login-form">
                            <input class="form-control" placeholder="아이디를 입력하세요." id="Username" name="username" type="text" />
                        </div>
                        <div class="form-group custom-login-form">
                                <input class="form-control" placeholder="비밀번호를 입력하세요." type="password" id="password" name="password" />
                                 <span id="errMsg"></span>
                         </div>
                           <button class="btn btn-lg btn-login btn-block"  id="login" onclick="javascript:loginFn(); return false;">로그인</button>
                    </fieldset>
                </form>
        </div>
        </div>
