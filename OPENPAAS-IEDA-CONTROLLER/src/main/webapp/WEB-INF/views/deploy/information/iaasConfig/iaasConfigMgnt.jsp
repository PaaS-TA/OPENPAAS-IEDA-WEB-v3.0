...
<div id="main">
    ...
    <div class="pdt20">
        ...
        <div id="iaas_config_mgnt_wrap">
            ...
            <sec:authorize access="hasAuthority('INFO_IAASCONFIG_OPENSTACK_MENU')">
                <ul class="col-md-3 well" onmouseover="hover(this);" onmouseout="unhover(this);" onclick="javascript:goPage('<c:url value="/info/iaasConfig/openstack"/>','Openstack 조회');">
            ...
            <sec:authorize access="hasAuthority('INFO_IAASCONFIG_GOOGLE_MENU')">
                <ul class="col-md-3 well" onmouseover="hover(this);" onmouseout="unhover(this);" onclick="javascript:goPage('<c:url value="/info/iaasConfig/google"/>','Google 조회');">
                    <li class="config-go-style">| 구글 환경 설정 관리 화면 이동</li>
                    <li><img src='images/iaasMgnt/google-icon.png' class="google-icon" alt="Google 조회"></li>
                    <li class="google-config-cnt"><span style="font-size: 14px;color:#000;">설정 정보 : </span></li>
                </ul>
            </sec:authorize>
            <sec:authorize access="hasAuthority('INFO_IAASCONFIG_VSPHERE_MENU')">
                <ul class="vSphere-box col-md-3 well" onmouseover="hover(this);" onmouseout="unhover(this);" onclick="javascript:goPage('<c:url value="/info/iaasConfig/vSphere"/>','vSphere 조회');">
