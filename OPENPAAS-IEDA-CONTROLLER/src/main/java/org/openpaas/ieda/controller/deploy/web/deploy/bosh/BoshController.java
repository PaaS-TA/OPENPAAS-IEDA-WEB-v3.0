package org.openpaas.ieda.controller.deploy.web.deploy.bosh;
...
import org.openpaas.ieda.deploy.web.deploy.bosh.dto.BoshListDTO;
import org.openpaas.ieda.deploy.web.deploy.bosh.dto.BoshParamDTO;
import org.openpaas.ieda.deploy.web.deploy.bosh.service.BoshDeleteDeployAsyncService;
import org.openpaas.ieda.deploy.web.deploy.bosh.service.BoshDeployAsyncService;
import org.openpaas.ieda.deploy.web.deploy.bosh.service.BoshSaveService;
import org.openpaas.ieda.deploy.web.deploy.bosh.service.BoshService;
...
public class BoshController extends BaseController {
	...
	*****************************************************************/
	...
	public String goBosh(){
		...
		return "/deploy/deploy/bosh/bosh";
	}
	...
	*****************************************************************/
	...
	public String goBoshPopup() {
		...
		return "/deploy/deploy/bosh/boshPopup";
	}
