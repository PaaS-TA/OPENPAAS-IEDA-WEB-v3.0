package org.openpaas.ieda.controller.openstack.web.securityGroup;
...
public class OpenstackSecurityGroupMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(OpenstackSecurityGroupMgntControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGoOpenstackSecurityGroupMgnt() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK 보안 그룹 관리 화면 이동 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    public void testGetOpenstackSecrityGroupIngressInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK 보안 그룹 목록 Inbound Rules 조회 TEST START  ================="); }
