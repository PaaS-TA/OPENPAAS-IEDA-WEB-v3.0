package org.openpaas.ieda.controller.openstack.web.keypairs;
...
public class OpenstackKeypairsMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(OpenstackKeypairsMgntControllerUnitTest.class);
    ...
    ***************************************************/
     ...
     ***************************************************/
     ...
     public void testGoOpenstackKeypairsMgnt() throws Exception{
         if(LOGGER.isInfoEnabled()){  LOGGER.info("================= testGoOpenstackKeypairsMgnt ================="); }
