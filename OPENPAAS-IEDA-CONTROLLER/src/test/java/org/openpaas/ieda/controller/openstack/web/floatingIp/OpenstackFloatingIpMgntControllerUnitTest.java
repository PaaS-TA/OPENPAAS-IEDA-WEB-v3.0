package org.openpaas.ieda.controller.openstack.web.floatingIp;
...
public class OpenstackFloatingIpMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(OpenstackFloatingIpMgntControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGoOpenstackFloatingIpMgnt() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK Floating IP 관리 화면 이동 TEST START  ================="); }
     ...
     ***************************************************/
     ...
     public void testSaveOpenstackFloatingIpInfo() throws Exception{
         if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK Floating IP 할당 TEST START  ================="); }
     ...
     ***************************************************/
     ...
     public void testGetPoolList() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK Floating IP Pool 목록 조회 TEST START  ================="); }
