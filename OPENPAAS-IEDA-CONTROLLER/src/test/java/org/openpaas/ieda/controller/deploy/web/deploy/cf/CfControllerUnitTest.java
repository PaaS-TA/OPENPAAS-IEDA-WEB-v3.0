...
public class CfControllerUnitTest extends BaseControllerUnitTest{
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(CfControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGoCf() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 설치 화면 이동 TEST"); }
    ...
    ***************************************************/
    ...
    public void testGoCfPopup() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 설치 팝업 화면 출력 TEST"); }
    ...
    ***************************************************/
    ...
    public void testGetCfList() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 정보 목록 조회 TEST"); }
    ...
    ***************************************************/
    ...
    public void testGetCfInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 정보 상세 조회 TEST"); }
        ...
        .andExpect(jsonPath("$.content.ingestorPort").value("25555"))
    ...
    ***************************************************/
    ...
    public void testSaveDefaultInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 기본 정보 저장 TEST"); }
        CfVO expectVo = setResultCfInfo();
    ...
    ***************************************************/
    ...
    public void testGetNetowrkListInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 네트워크 정보 조회 TEST"); }
    ...
    ***************************************************/
    ...
    public void testSaveNetworkCfInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 네트워크 정보 저장 TEST"); }
    ...
    /***************************************************
    * @project : Paas 플랫폼 설치 자동화
    * @description : CF KEY 정보 저장 TEST
    * @title : testSaveKeyInfo
    * @return : void
    ***************************************************/
    @Test
    public void testSaveKeyInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF KEY 정보 저장 TEST"); }
    ...
    /***************************************************
    * @project : Paas 플랫폼 설치 자동화
    * @description : CF 리소스 정보 저장 TEST
    * @title : testSaveResourceCfInfo
    * @return : void
    ***************************************************/
    @Test
    public void testSaveResourceCfInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 리소스 정보 저장 TEST"); }
        ResourceDTO dto = cfResourceInfo();
        Map<String, Object> expectMap = setResultResourceInfo();
    ...
    ***************************************************/
    ...
    /***************************************************
    * @project : Paas 플랫폼 설치 자동화
    * @description : CF 플랫폼 설치 TEST
    * @title : testInstallCf
    * @return : void
    ***************************************************/
    @Test
    public void testInstallCf() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 플랫폼 설치 TEST"); }
        CfParamDTO.Install dto = setCfIntallParam();
    ...
    ***************************************************/
    ...
    public void testDeleteCf(){
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 플랫폼 삭제 TEST"); }
    ...
    ***************************************************/
    ...
    public void testDeleteJustOnlyCfRecord() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("============================> CF 플랫폼 단순 레코드 삭제 TEST"); }
        CfParamDTO.Delete dto = setCfDeleteInfo();
    ...
    ***************************************************/
    public Map<String, Object> setResultResourceInfo() {
