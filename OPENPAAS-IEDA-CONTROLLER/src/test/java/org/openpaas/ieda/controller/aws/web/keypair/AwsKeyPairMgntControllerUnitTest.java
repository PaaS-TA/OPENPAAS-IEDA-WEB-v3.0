package org.openpaas.ieda.controller.aws.web.keypair;
...
import org.openpaas.ieda.awsMgnt.web.keypair.dto.AwsKeypairMgntDTO;
...
public class AwsKeyPairMgntControllerUnitTest  extends BaseControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(AwsKeyPairMgntControllerUnitTest.class);
    /*************************************** URL *******************************************/
    ...
    ***************************************************/
    ...
    public void testGoAwsKeyPairList() throws Exception{
        if(LOGGER.isInfoEnabled()){
            LOGGER.info("================= AWS Key Pair 목록 화면 이동 TEST START  =================");
        }
    ...
    ***************************************************/
    ...
    /***************************************************
     * @project : AWS 관리 대시보드
     * @description : AWS Key Pair 생성 값 설정
     * @title : setCreateAwsKeyPair
     * @return : AwsKeypairdMgntDTO
     ***************************************************/
    private AwsKeypairMgntDTO setCreateKeyPair(){
        AwsKeypairMgntDTO dto = new AwsKeypairMgntDTO();
        dto.setAccountId("1");
        dto.setKeyPairName("testKeyPair");
        return dto;
    }
