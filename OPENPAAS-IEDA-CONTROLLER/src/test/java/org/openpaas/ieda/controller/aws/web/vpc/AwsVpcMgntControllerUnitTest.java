package org.openpaas.ieda.controller.aws.web.vpc;
...
public class AwsVpcMgntControllerUnitTest {
    ...
    ***************************************************/
    ...
    public void testGoAwsVpcMgnt() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS VPC 관리 화면 이동 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    public void testGetAwsVpcInfoList() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS VPC 목록 조회 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    public void testGetAwsVpcDetailInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS VPC 상세 조회 TEST START  ================="); }
