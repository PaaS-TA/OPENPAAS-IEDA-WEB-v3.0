package org.openpaas.ieda.controller.aws.web.internetGateway;
...
import org.openpaas.ieda.controller.aws.web.vpc.AwsVpcMgntControllerUnitTest;
...
public class AwsInternetGatewayMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(AwsVpcMgntControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGoAwsInternetGateWay() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS 인터넷 게이트웨이 화면 이동 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    public void testGetAwsVpcInfoList() throws Exception {
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS 인터넷게이트웨이에 연결 할 VPC 조회 TEST START  ================="); }
...
d     * @throws JsonProcessingException 
    ***************************************************/
    ...
    public void testInternetGatewayAttachVpc() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS 인터넷게이트웨이에 VPC 연결 TEST START  ================="); }
        AwsInternetGatewayMgntDTO dto = setInternetGatewayInfo();
    ...
    ***************************************************/
    ...
    public void testInternetGatewayDetachVpc() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS 인터넷게이트웨이에 VPC 연결 해제 TEST START  ================="); }
        AwsInternetGatewayMgntDTO dto = setInternetGatewayInfo();
