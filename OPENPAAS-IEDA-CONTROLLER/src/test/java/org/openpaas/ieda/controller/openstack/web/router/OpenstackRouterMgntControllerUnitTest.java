package org.openpaas.ieda.controller.openstack.web.router;
...
public class OpenstackRouterMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(OpenstackRouterMgntControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGoOpenstackRouterMgnt() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  testGoOpenstackRouterMgnt ================="); }
     ...
     ***************************************************/
     ...
     public void testCreateOpenstackRouter() throws Exception{
         if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  testCreateOpenstackRouter ================="); }
      ...
      ***************************************************/
      ...
      public void testDeleteOpenstackRouter() throws Exception{
          if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  testDeleteOpenstackRouter  ================="); }
          OpenstackRouterMgntDTO dto = setOpenstackSaveDto();
      ...
      ***************************************************/
      ...
      public void testOpenstackRouterInterfaceInfoList() throws Exception{
          if(LOGGER.isInfoEnabled()){ LOGGER.info("=================  testOpenstackRouter Interface 정보 리스트 TEST ================="); }
      ...
      public void testOpenstackRouterInterfaceSubnetInfoList() throws Exception{
          if(LOGGER.isInfoEnabled()){ LOGGER.info("=================  testOpenstackRouter Interface Subnet 리스트 TEST ================="); }
      ...
      ***************************************************/
      ...
      public void testAttachOpenstackRouterInterface() throws Exception{
          if(LOGGER.isInfoEnabled()){ LOGGER.info("=================  testOpenstackRouter Interface 연결 TEST ================="); }
       ...
       ***************************************************/
       ...
       public void testDetachOpenstackRouterInterface() throws Exception{
           if(LOGGER.isInfoEnabled()){ LOGGER.info("=================  testOpenstackRouter Interface 연결해제 TEST ================="); }
           OpenstackRouterMgntVO vo = setAttachOpenstackRouterInterfaceInfo();
       ...
       ***************************************************/
       ...
       public void testOpenstackRouterGatewayAttach() throws Exception{
           if(LOGGER.isInfoEnabled()){ LOGGER.info("=================  testOpenstackRouter Gateway 연결 TEST ================="); }
           OpenstackRouterMgntVO vo = setAttachOpenstackRouterInterfaceInfo();
       ...
       public void testOpenstackRouterExternalNetworkInfoList() throws Exception{
           if(LOGGER.isInfoEnabled()){ LOGGER.info("=================  testOpenstackRouter Router External Network 조회 TEST ================="); }
           List<OpenstackNetworkMgntVO> expectIntSubList = setOpenstackRouterInterfaceSubnetInfoList();
           ...
           .andExpect(status().isOk())
           .andExpect(jsonPath("$.[0].networkId").value(expectIntSubList.get(0).getNetworkId()))
           .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
       }
      /***************************************************
      * @project : OPENSTACK 인프라 관리 대시보드
