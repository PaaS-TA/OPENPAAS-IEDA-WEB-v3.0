package org.openpaas.ieda.controller.aws.web.elasticIp;
...
public class AwsElasticIpMgntControllerUnitTest{
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(AwsElasticIpMgntControllerUnitTest.class);
    /*************************************** URL *******************************************/
     ...
     ***************************************************/
      ...
      ***************************************************/
      ...
      public void testGoAwsElasticIpMgnt() throws Exception{
          if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS ElasticIp 관리 화면 이동 TEST START  ================="); }
       ...
       ***************************************************/
       ...
       public void testGetAwsElasticIpInfoList() throws Exception{
           if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS ElasticIp 목록 조회 TEST START  ================="); }
        ...
        ***************************************************/
        ...
        public void testGetAwsElasticIpDetailInfo() throws Exception{
            if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS ElasticIp 상세 조회 TEST START  ================="); }
         ...
         ***************************************************/
         ...
         public void testSaveAwsElasticIpInfo() throws Exception{
             if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS Elastic IP 생성 TEST START  ================="); }
