package org.openpaas.ieda.controller.openstack.web.network;
...
public class OpenstackNetworkMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(OpenstackNetworkMgntControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    public void testGoOpenstackNetworkMgnt() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK 네트워크 관리 화면 이동 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    public void testSaveOpenstackNetworkInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK 네트워크 생성 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    public void testSaveOpenstackSubnetkInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  OPENSTACK 서브넷 생성 TEST START  ================="); }
        OpenstackNetworkMgntDTO dto = setOpenstackSaveDto();
