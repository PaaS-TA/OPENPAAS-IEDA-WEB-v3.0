package org.openpaas.ieda.controller.aws.web.subnet;
...
@WebAppConfiguration
public class AwsSubnetMgntControllerUnitTest {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(AwsSubnetMgntControllerUnitTest.class);
     ...
     ***************************************************/
      ...
      ***************************************************/
      ...
      public void testGoAwsSubnetMgnt() throws Exception{
          if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS Subnet 관리 화면 이동 TEST START  ================="); }
       ...
       ***************************************************/
       ...
       public void testGetAwsSubnetInfoList() throws Exception{
           if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS SUBNET 목록 조회 TEST START  ================="); }
        ...
        ***************************************************/
        ...
        public void testGetAwsVpcDetailInfo() throws Exception{
            if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS Subnet 상세 조회 TEST START  ================="); }
         ...
         ***************************************************/
         ...
         public void testSaveAwsSubnetInfo() throws Exception{
             if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS Subnet 생성 TEST START  ================="); }
             AwsSubnetMgntDTO dto = setSubnetInfo();
             mockMvc.perform(post(SUBNET_SAVE_URL).contentType(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)
         ...
         ***************************************************/
         ...
         public void testDeleteAwsSubnetInfo() throws Exception{
             if(LOGGER.isInfoEnabled()){  LOGGER.info("================= AWS Subnet 삭제 TEST START  ================="); }
             AwsSubnetMgntDTO dto = setSubnetInfo();
             mockMvc.perform(delete(SUBNET_DELETE_URL).contentType(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)
                     .content(mapper.writeValueAsBytes(dto))).andDo(MockMvcResultHandlers.print())
