...
public class CommonCodeControllerUnitTest {
    
    private MockMvc mockMvc;
    private static final ObjectMapper mapper = new ObjectMapper();
    private Principal principal = null;
    final static Logger LOGGER = LoggerFactory.getLogger(CommonCodeControllerUnitTest.class);
    ...
    ***************************************************/
    ...
    /***************************************************
    * @project : Paas 플랫폼 설치 자동화
    * @description : 코드 관리 화면 이동 TEST
    * @title : testGoCodeManagement
    * @return : void
    ***************************************************/
    @Test
    public void testGoCodeManagement() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  코드 관리 화면 이동 TEST START  ================="); }
    ...
    ***************************************************/
    ...
    /***************************************************
    * @project : Paas 플랫폼 설치 자동화
    * @description : 코드 조회 TEST
    * @title : testGetCodeListInfo
    * @return : void
    ***************************************************/
    @Test
    public void testGetCodeListInfo() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  코드 조회 TEST START  ================="); }
        List<CommonCodeVO> expectList = setResultCodeInfo();
        when(mockCommonCodeService.getSubGroupCodeList(anyString(), anyString(), anyString() )).thenReturn(expectList);
    ...
    ***************************************************/
    ...
    public void testDeleteCode() throws Exception{
        if(LOGGER.isInfoEnabled()){  LOGGER.info("=================  코드 삭제 TEST START  ================="); }
        CommonCodeDTO.Regist dto = setCodeSaveInfo("null");
