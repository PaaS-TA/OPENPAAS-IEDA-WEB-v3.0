package org.openpaas.ieda.deploy.web.deploy.cf;
...
public class CfControllerTest extends BaseControllerTest {
    ...
    final static String SAVE_DEFAULT_INFO_URL = "/deploy/cf/install/saveDefaultInfo";//기본 정보 저장
    ...
    final static String SAVE_RESOURCE_INFO_URL = "/deploy/cf/install/saveResourceInfo";//리소스 정보 저장
    final static String MAKE_DEPLOYMENTFILE_URL = "/deploy/cf/install/createSettingFile";//배포 파일 생성
    ...
    *****************************************************************/
    ...
    public void testInstallCf() throws Exception{
        ...
        testCreateKeyInfo();
        testSaveResourceCfInfo();
        testMakeDeploymentFile();
        testDoInstallCf();
        testDeleteJustOnlyCfRecord();
    }
    ...
    *****************************************************************/
    public void testDeleteJustOnlyCfRecord() throws Exception {
        ...
        if(LOGGER.isInfoEnabled()){ 
            LOGGER.info("==================================testDeleteJustOnlyCfRecord"); 
        }
