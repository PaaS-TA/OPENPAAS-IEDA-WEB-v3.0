package org.openpaas.ieda.deploy.web.deploy.cfDiego;
...
import org.openpaas.ieda.deploy.web.deploy.cf.CfServiceTest;
...
import org.openpaas.ieda.deploy.web.deploy.diego.DiegoServiceTest;
...
public class CfDiegoControllerTest extends BaseControllerTest {
    ...
    final static String SAVE_DEFAULT_INFO_URL = "/deploy/cfDiego/install/saveDefaultInfo";//기본 정보 저장 
    ...
    final static String SAVE_RESOURCE_INFO_URL = "/deploy/cfDiego/install/saveResourceInfo";//리소스 정보 저장
    final static String MAKE_DEPLOYMENTFILE_URL = "/deploy/cfDiego/install/createSettingFile";//배포 파일 생성
    ...
    *****************************************************************/
    ...
    public void testSaveDefaultInfo() throws Exception {
        ...
        cfDao.insertCfInfo(setDefaultInfoVO());
        saveDefaultInfo("cf");
        testGetCountryCodeList();
        testCreateKeyInfo();
        testSaveKeyInfo();
        testSaveNetworkCfInfo();
        testSaveResourceInfo();
    ...
    /****************************************************************
     * @project : Paas 플랫폼 설치 자동화
     * @description : 기본 정보 VO 설정 
     * @title : setDefaultInfoVO
     * @return : CfVO
    *****************************************************************/
    private CfVO setDefaultInfoVO(){
        CfVO vo = new CfVO();
        vo.setId(1);
        ...
        vo.setDomain("172.12.34.100.xip.io");
