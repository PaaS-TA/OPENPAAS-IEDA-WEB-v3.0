...
public class ServicePackControllerTest extends BaseControllerTest{
	...
	final private static String FILE_PATH = System.getProperty("user.dir") + SEPARATOR + "test/main/java/org/openpaas/ieda/deploy/web/assets/servicepack-test.yml";
