package org.openpaas.ieda.deploy.web.deploy.diego;
...
public class DiegoControllerTest extends BaseControllerTest{
    ...
    final static String DIEGO_DEFAULT_URL = "/deploy/diego/install/saveDefaultInfo"; //기본 정보 저장
    final static String DIEGO_NETWORK_URL = "/deploy/diego/install/saveNetworkInfo"; //네트워크 정보 저장
    final static String DIEGO_RESOURCE_URL = "/deploy/diego/install/saveResourceInfo"; //리소스 정보 저장
    final static String DIEGO_RECORD_DELETE_URL = "/deploy/diego/delete/data"; //단순 Diego 레코드 삭제
    final static String CREATE_SETTING_FILE_URL = "/deploy/diego/install/createSettingFile"; //배포 파일 생성
    ...
    *****************************************************************/
    ...
    /****************************************************************
     * @project : Paas 플랫폼 설치 자동화
     * @description : Diego 설치 통합 테스트
     * @title : testDiegoInstall
     * @return : void
    *****************************************************************/
    @Test
    public void testDiegoInstall()throws Exception{
        if(LOGGER.isInfoEnabled()){ 
            LOGGER.info("==================================> testDiegoInstall"); 
        }
        diegoDao.insertDiegoDefaultInfo(setDiegoDefulatInfoVO());
        testSaveDefaultInfo();
        testNetworkInfoSave();
        testCreateKeyInfo();
        testResourceInfoSave();
        testJustDiegoInfoDelete();
    }
    ...
    *****************************************************************/
    ...
    /****************************************************************
     * @project : Paas 플랫폼 설치 자동화
     * @description : Diego 기본 정보 VO 설정
     * @title : setDiegoDefulatInfoVO
     * @return : DiegoVO
    *****************************************************************/
    private DiegoVO setDiegoDefulatInfoVO(){
        ...
        vo.setCfDeployment("cf-openstack-diego");
